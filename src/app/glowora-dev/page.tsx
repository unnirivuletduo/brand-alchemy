    ...
    <>
      ...
      <section className="w-full px-6 md:px-20 py-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-[80px]">
          <div className="w-full overflow-hidden">
            <Image width="1000" height="1000" src="/images/glowora/image4.jpeg" alt="image" className="w-full h-[480px] object-cover" />
          </div>
          <div className="w-full overflow-hidden">
            <Image width="1000" height="1000" src="/images/glowora/image2.jpeg" alt="image" className="w-full h-[480px] object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-6 md:px-20 pb-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-[80px]">
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image5.jpeg" className="w-full h-auto object-cover mb-4" />
          ...
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image10.jpeg" className="w-full h-auto object-cover mb-4" />
      ...
      <section className="w-full px-6 md:px-20 pb-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-[80px]">
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image3.jpeg" className="w-full h-auto object-cover mb-4" />
          ...
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image2.jpeg" className="w-full h-auto object-cover mb-4" />
          ...
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image4.jpeg" className="w-full h-auto object-cover mb-4" />
      ...
      <section className="w-full px-6 md:px-20 pb-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-[80px]">
          <div className="w-full overflow-hidden">
            <Image alt="image" width="1000" height="1000" src="/images/glowora/image8.jpeg" className="w-full h-auto object-cover mb-4" />
